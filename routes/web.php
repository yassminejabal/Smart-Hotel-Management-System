...
Route::patch('/reservations/{id}/status', [ReservationController::class, 'updateStatus'])->name('reservations.updateStatus')->middleware(ReceptionnisteMiddleware::class);
...
Route::patch('/reservations/{id}/payment-status', [ReservationController::class, 'updatePaymentStatus'])->name('reservations.updatePaymentStatus')->middleware(ReceptionnisteMiddleware::class);
Route::get('/reservations/{id}/paiement', [App\Http\Controllers\ReservationController::class, 'showPaiement'])->name('reservations.paiement')->middleware(ReceptionnisteMiddleware::class);
