...
class DashboardController extends Controller
{
    ...
    public function reseptionneste()
    {
        ...
        return view('dashboard.reseptionneste', compact('totalReservations', 'totalClients', 'totalRevenue', 'disponibles', 'reservations'));
    }
    public function client()
    {
        $client = Auth::user();

        $reservations = Reservation::with('chambre')->where('client_id', $client->id)->paginate(6);
